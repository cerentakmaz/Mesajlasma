...
namespace intprog.Controllers
{
    ...
    public class ServisController : ApiController
    {
        ...
        {
            if (db.Mesaj.Count(c => c.Mesaj1 == model.Mesaj1) > 0)
            {
                sonuc.islem = false;
                sonuc.mesaj = "Bu Mesaj Mevcuttur";
                return sonuc;
            }
